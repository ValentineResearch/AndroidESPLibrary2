...
public class RequestSAVVYStatus extends RequestPacket {
    ...
    public RequestSAVVYStatus(DeviceId v1Type) {
        super(v1Type, DeviceId.V1CONNECTION, DeviceId.SAVVY, PacketId.REQSAVVYSTATUS, null);
    }

    public RequestSAVVYStatus(int packetLength) {
        super(packetLength);
    }
}
