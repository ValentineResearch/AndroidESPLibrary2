...
public class RequestVersion extends RequestPacket {
    ...
    public RequestVersion(DeviceId v1Type, DeviceId destination) {
        super(v1Type, DeviceId.V1CONNECTION, destination, PacketId.REQVERSION, null);
    }

    public RequestVersion(int packetLength) {
        super(packetLength);
    }
}
