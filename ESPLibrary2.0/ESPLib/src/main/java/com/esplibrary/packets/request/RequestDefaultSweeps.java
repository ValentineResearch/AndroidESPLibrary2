...
public class RequestDefaultSweeps extends RequestPacket {
    ...
    public RequestDefaultSweeps(DeviceId v1Type) {
        super(v1Type, DeviceId.V1CONNECTION, v1Type, PacketId.REQDEFAULTSWEEPS, null);
    }

    public RequestDefaultSweeps(int packetLength) {
        super(packetLength);
    }
}
