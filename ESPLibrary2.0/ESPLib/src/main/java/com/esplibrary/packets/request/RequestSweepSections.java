...
public class RequestSweepSections extends RequestPacket {
    ...
    public RequestSweepSections(DeviceId v1Type) {
        super(v1Type, DeviceId.V1CONNECTION, v1Type, PacketId.REQSWEEPSECTIONS, null);
    }

    public RequestSweepSections(int packetLength) {
        super(packetLength);
    }
}
