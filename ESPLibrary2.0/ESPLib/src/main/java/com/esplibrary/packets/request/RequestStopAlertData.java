...
public class RequestStopAlertData extends RequestPacket {
    ...
    public RequestStopAlertData(DeviceId v1Type) {
        super(v1Type, DeviceId.V1CONNECTION, v1Type, PacketId.REQSTOPALERTDATA, null);
    }

    public RequestStopAlertData(int packetLength) {
        super(packetLength);
    }
}
