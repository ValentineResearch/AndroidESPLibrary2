...
public class RequestStartAlertData extends RequestPacket {
    ...
    public RequestStartAlertData(DeviceId v1Type) {
        super(v1Type, DeviceId.V1CONNECTION, v1Type, PacketId.REQSTARTALERTDATA, null);
    }

    public RequestStartAlertData(int packetLength) {
        super(packetLength);
    }
}
