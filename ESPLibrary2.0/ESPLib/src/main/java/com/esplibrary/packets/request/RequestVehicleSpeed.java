...
public class RequestVehicleSpeed extends RequestPacket {
    ...
    public RequestVehicleSpeed(DeviceId v1Type) {
        super(v1Type, DeviceId.V1CONNECTION, DeviceId.SAVVY, PacketId.REQVEHICLESPEED, null);
    }

    public RequestVehicleSpeed(int packetLength) {
        super(packetLength);
    }
}
